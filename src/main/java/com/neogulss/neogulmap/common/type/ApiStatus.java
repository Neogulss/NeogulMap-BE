package com.neogulss.neogulmap.common.type;
...
public enum ApiStatus {
  ...
  HTTP_INTERFACE_API_ERROR("806", "외부 API 호출 오류 입니다."),
  EXPIRED_JWT("807", "토큰 유효 기간이 만료 되었습니다."),
  UNSUPPORTED_JWT("808", "옳바르지 않는 토큰 입니다."),
  EMPTY_REDIS("809", "레디스에 저장된 정보가 없습니다."),
  EMPTY_JWT("811", "토큰정보가 존재하지 않습니다."),
